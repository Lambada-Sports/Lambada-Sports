...
const handleStopErase = () => {
  ...
  if (canvas) {
    ...
    // 🔑 FIX: Editor image-ஐ clear பண்ணுறது prevent duplicate
    setEditorImage(null)
    }
  }
  ...
  return (
    <div>
      ...
      >
        ...
        <button onClick={handleStopErase} className="bg-blue-500 text-white px-3 py-1 rounded">Stop Erase</button>
        <button onClick={handleStartCrop} className="bg-yellow-500 text-white px-3 py-1 rounded">Start Crop</button>
        <button onClick={handleApplyCrop} className="bg-yellow-700 text-white px-3 py-1 rounded">Apply Crop</button>
