      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center text-white px-4 max-w-8xl mx-auto">
          ...
          <p className="text-lg md:text-xl lg:text-2xl mb-8 font-medium max-w-4xl mx-auto text-gray-200">
            Built to perform and made to last, our process delivers precise personalization and
            pro-grade materials from first mockup to final stitch.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center items-center mt-12">
            ...
            <button className="group bg-black text-white px-10 py-4 text-xl font-bold rounded-lg hover:bg-gray-800 transition-all duration-300 transform hover:scale-105 shadow-lg min-w-[280px] border-2 border-gray-700 hover:border-gray-600">
              <span className="flex items-center justify-center gap-3">
      ...
      <section className="relative py-16 bg-black text-white overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-4xl md:text-5xl font-bold mb-6">
            <span className="text-green-400">Custom Jerseys</span>
          </h2>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-wrap justify-center items-center gap-8 mb-12">
            ...
            {[1, 2, 3, 4, 5, 6].map((logo) => (
              <div key={logo} className="w-16 h-16 bg-gray-200 rounded-lg flex items-center justify-center">
      ...
      <section className="bg-gray-100 py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-gray-600 mb-6">Subscribe for exclusive deals, product updates & early-bird deals. No spam, pinky promise.</p>
